...
DEFAULT_SECONDARY_SIGNAL_PRESENCE_ENABLED = False
DEFAULT_SECONDARY_SIGNAL_PRESENCE_ENTITIES: tuple[str, ...] = ()
DEFAULT_SECONDARY_SIGNAL_VOICE_ENABLED = False
DEFAULT_SECONDARY_SIGNAL_VOICE_TTL_SECONDS = 30.0
DEFAULT_MAX_LATENCY_MS = 2000.0
DEFAULT_REQUIRE_VERIFIED_USER_FOR_DANGEROUS = False
DEFAULT_VERIFIED_USERS: tuple[str, ...] = ()
...
OPT_REQUIRE_VERIFIED_USER_FOR_DANGEROUS = "require_verified_user_for_dangerous"
OPT_VERIFIED_USERS = "verified_users"
...
DEFAULT_OPTION_VALUES = (
    ...
    (OPT_SECONDARY_SIGNAL_PRESENCE_ENABLED, DEFAULT_SECONDARY_SIGNAL_PRESENCE_ENABLED),
    (OPT_SECONDARY_SIGNAL_PRESENCE_ENTITIES, DEFAULT_SECONDARY_SIGNAL_PRESENCE_ENTITIES),
    (OPT_SECONDARY_SIGNAL_VOICE_ENABLED, DEFAULT_SECONDARY_SIGNAL_VOICE_ENABLED),
    (
    ...
    (OPT_REQUIRE_VERIFIED_USER_FOR_DANGEROUS, DEFAULT_REQUIRE_VERIFIED_USER_FOR_DANGEROUS),
    (OPT_VERIFIED_USERS, DEFAULT_VERIFIED_USERS),
